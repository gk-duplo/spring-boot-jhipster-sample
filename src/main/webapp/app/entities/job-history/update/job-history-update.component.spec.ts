...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 32601 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 18280 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 22840 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 5548 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 29627 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 14776 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 27875 };
      jobHistory.job = job;
      const department: IDepartment = { id: 16731 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 7625 };
      jobHistory.employee = employee;
