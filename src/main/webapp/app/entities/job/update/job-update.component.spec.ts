...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 29015 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 6605 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 29901 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 17317 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 17135 };
      job.tasks = [task];
      const employee: IEmployee = { id: 22451 };
      job.employee = employee;
